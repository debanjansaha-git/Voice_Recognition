...
disp('By  Debanjan Saha, Anish Ghosh, Rahul Das, Anik Ghosh and Sreenjay Sen');
disp(' ');
pause(0.5);
disp('LOADING ');
pause(1);
...
%% 10.1 Add a new sound from microphone
        ...
        if chos==1
            ...
            if (exist('sound_database.dat','file')==2)
                ...
                audiowrite(y1,samplingfrequency,samplingbits,st)
...
%% 10.2 Voice Recognition from microphone
        ...
        if chos==2
            ...
            if (exist('sound_database.dat','file')==2)
                ...
                st='v';
                audiowrite(y,samplingfrequency,samplingbits,st);
                y = getaudiodata(micrecorder, 'uint8');
